  ...
  return (
    ...
    <div className='max-w-4xl px-4 mx-auto sm:px-6 lg:px-8 '>
      <div className="pb-12 border-b border-gray-900/10">
          <h2 className="text-xl font-semibold leading-7 text-gray-900">Update Your Profile</h2>
            ...
            <div className="sm:col-span-4">
              ...
              <div className="mt-2">
                <select
                  ...
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 pl-3 sm:max-w-xs sm:text-sm sm:leading-6"
                >
